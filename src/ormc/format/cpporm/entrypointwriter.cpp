 ...
 * \details
 */
bool EntryPointImplementationWriter::VisitNode(const NodeContext &context)
{
 ...
 * \brief
 */
const std::string EntryPointImplementationWriter::cDefineEntityFactory
    = "\n"
      "/*\n"
      " * The entity factory\n"
      " */\n"
 ...
 * \brief
 */
const std::string EntryPointImplementationWriter::cRegisterEntity
    = "        Register<%1%>(\"%1%\");\n";
