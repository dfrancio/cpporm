/*!
 * \file
 * \brief     cpporm standalone header writer implementation
 ...
 * \details
 */
StandaloneHeaderPreambleWriter::~StandaloneHeaderPreambleWriter()
{
    ...
    : GraphVisitor(listGraph)
{
    ...
    if (FLAGS_namespace.empty())
        ...
        mStream << boost::format(cPreambleText) % (name + ".h") % CPPORM_VERSION % FLAGS_namespace;
}

/*!
 * \details
 */
bool StandaloneHeaderPreambleWriter::VisitNode(const NodeContext &context)
{
 ...
 * \details
 */
StandaloneHeaderSchemaWriter::~StandaloneHeaderSchemaWriter()
{
    if (!FLAGS_namespace.empty())
 ...
 * \details
 */
bool StandaloneHeaderSchemaWriter::VisitNode(const NodeContext &context)
{
 ...
 * \details
 */
bool StandaloneHeaderSchemaWriter::VisitField(const FieldContext &context)
{
 ...
 * \details
 */
bool StandaloneHeaderSchemaWriter::VisitIndex(const IndexContext &context)
{
 ...
 * \details
 */
bool StandaloneHeaderSchemaWriter::VisitOutEdge(const EdgeContext &context)
{
 ...
 * \details
 */
bool StandaloneHeaderSchemaWriter::VisitInEdge(const EdgeContext &context)
{
    assert(
 ...
 * \details
 */
void StandaloneHeaderSchemaWriter::CheckWriteVersionFields(const Node &node)
{
 ...
 * \details
 */
const std::string StandaloneHeaderPreambleWriter::cPreambleText
    = "/*\n"
      " * %s\n"
      " *\n"
 ...
 * \details
 */
const std::string StandaloneHeaderPreambleWriter::cPreambleTextNoNamespace
    = "/*\n"
      " * %s\n"
      " *\n"
      " * generated by the ORM-compiler version %s\n"
 ...
 * \details
 */
const std::string StandaloneHeaderPreambleWriter::cForwardDeclareEntity = "struct %s;\n";

/*!
 * \details
 */
const std::string StandaloneHeaderPreambleWriter::cDeclareEntityCreator
    = "\n"
      "/*\n"
 ...
 * \details
 */
const std::string StandaloneHeaderSchemaWriter::cDeclareEntity
    = "\n"
      "/*******************************************************************************\n"
      " * %1%\n"
      " ******************************************************************************/\n"
 ...
 * \details
 */
const std::string StandaloneHeaderSchemaWriter::cDeclareEntityMethods
    = "    CPPORM_DECLARE_ENTITY_METHODS;\n";

/*!
 * \details
 */
const std::string StandaloneHeaderSchemaWriter::cDeclareAttribute
    = "    CPPORM_DECLARE_ATTRIBUTE(%s);\n";

/*!
 * \details
 */
const std::string StandaloneHeaderSchemaWriter::cDeclareIndex = "    CPPORM_DECLARE_INDEX(%s);\n";

/*!
 * \details
 */
const std::string StandaloneHeaderSchemaWriter::cDeclareToOneRelationship
    = "    CPPORM_DECLARE_TO_ONE_RELATIONSHIP(%s, %s);\n";

/*!
 * \details
 */
const std::string StandaloneHeaderSchemaWriter::cDeclareToManyRelationship
    = "    CPPORM_DECLARE_TO_MANY_RELATIONSHIP(%s);\n";

/*!
 * \details
 */
const std::string StandaloneHeaderSchemaWriter::cNamespaceEnd = "\n"
                                                                "} // namespace %s\n";
