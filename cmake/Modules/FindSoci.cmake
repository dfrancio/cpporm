...
FIND_PATH(
    SOCI_INCLUDE_DIR
    NAMES soci.h
    HINTS ${SOCI_SEARCH_DIRS}
    PATH_SUFFIXES include soci
...
SET(VERSION_SUFFIX)
if(WIN32 AND Soci_FIND_VERSION_MAJOR GREATER 0)
    SET(VERSION_SUFFIX "_${Soci_FIND_VERSION_MAJOR}")
endif()
if(WIN32 AND Soci_FIND_VERSION_MINOR GREATER 0)
    SET(VERSION_SUFFIX "${VERSION_SUFFIX}_${Soci_FIND_VERSION_MINOR}")
endif()

#
### SECOND STEP: Find the soci core library.
#
FIND_LIBRARY(
    SOCI_LIBRARY
    NAMES soci_core${VERSION_SUFFIX}
...
IF(SOCI_INCLUDE_DIR AND SOCI_LIBRARY)
    ...
    FOREACH(plugin IN LISTS _SOCI_ALL_PLUGINS)
        ...
        FIND_LIBRARY(
            ...
            NAMES soci_${plugin}${VERSION_SUFFIX}
            HINTS ${SOCI_INCLUDE_DIR}/..
            PATH_SUFFIXES lib lib64)
