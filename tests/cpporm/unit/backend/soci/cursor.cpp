...
// Test fixture
class CppOrm_Unit_Backend_Soci_Cursor : public testing::Test
{
protected:
    CppOrm_Unit_Backend_Soci_Cursor()
    {
...
TEST_F(CppOrm_Unit_Backend_Soci_Cursor, TestSet2)
{
...
TEST_F(CppOrm_Unit_Backend_Soci_Cursor, DISABLED_TestSet3)
{
...
TEST_F(CppOrm_Unit_Backend_Soci_Cursor, TestSet4)
{
