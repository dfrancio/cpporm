 ...
 * sample1.mysql.cpp
 *
 * generated by the ORM-compiler version 0.1.4
 */
 ...
 * User
 ******************************************************************************/
CPPORM_REGISTER_string(EntityFactory, User, User);
...
{
    static const cpporm::PropertyMap cMap = {{"IDENTITY", ""}, {"NOT_NULL", ""}};
    return cMap;
}
...
{
    static const cpporm::PropertyMap cMap = {{"DEFAULT", "CURRENT_TIMESTAMP"}, {"NOT_NULL", ""}};
    return cMap;
}
 ...
 * Organization
 ******************************************************************************/
CPPORM_REGISTER_string(EntityFactory, Organization, Organization);
 ...
 * Team
 ******************************************************************************/
CPPORM_REGISTER_string(EntityFactory, Team, Team);
 ...
 * OrganizationType
 ******************************************************************************/
CPPORM_REGISTER_string(EntityFactory, OrganizationType, OrganizationType);
 ...
 * TeamMembership
 ******************************************************************************/
CPPORM_REGISTER_string(EntityFactory, TeamMembership, TeamMembership);
