 ...
 * sample1.mysql.cpp
 *
 * generated by the ORM-compiler version 0.2.6
 */
...
{
    auto *result = new OrganizationType();
    *result = *this;
    return result;
}
...
{
    auto *result = new TeamMembership();
    *result = *this;
    return result;
}
