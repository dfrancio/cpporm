...
struct User FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    const flatbuffers::String *deleted_at() const
    {
        return GetPointer<const flatbuffers::String *>(VT_DELETED_AT);
    }
    const flatbuffers::String *created_by() const
    {
        return GetPointer<const flatbuffers::String *>(VT_CREATED_BY);
    }
    const flatbuffers::String *updated_by() const
    {
        return GetPointer<const flatbuffers::String *>(VT_UPDATED_BY);
    }
    const flatbuffers::String *deleted_by() const
    {
        return GetPointer<const flatbuffers::String *>(VT_DELETED_BY);
    }
    ...
    const flatbuffers::String *birth_date() const
    {
        return GetPointer<const flatbuffers::String *>(VT_BIRTH_DATE);
    }
    const flatbuffers::String *personal_id() const
    {
        return GetPointer<const flatbuffers::String *>(VT_PERSONAL_ID);
    }
    const flatbuffers::String *professional_id() const
    {
        return GetPointer<const flatbuffers::String *>(VT_PROFESSIONAL_ID);
    }
    const User *created_by_User() const
    {
        return GetPointer<const User *>(VT_CREATED_BY_USER);
    }
    const User *updated_by_User() const
    {
        return GetPointer<const User *>(VT_UPDATED_BY_USER);
    }
    const User *deleted_by_User() const
    {
        return GetPointer<const User *>(VT_DELETED_BY_USER);
    }
    const flatbuffers::Vector<flatbuffers::Offset<User>> *User_created_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<User>> *>(
            VT_USER_CREATED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<User>> *User_updated_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<User>> *>(
            VT_USER_UPDATED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<User>> *User_deleted_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<User>> *>(
            VT_USER_DELETED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Organization>> *Organization_created_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Organization>> *>(
            VT_ORGANIZATION_CREATED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Organization>> *Organization_updated_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Organization>> *>(
            VT_ORGANIZATION_UPDATED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Organization>> *Organization_deleted_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Organization>> *>(
            VT_ORGANIZATION_DELETED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Team>> *Team_created_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Team>> *>(
            VT_TEAM_CREATED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Team>> *Team_updated_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Team>> *>(
            VT_TEAM_UPDATED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Team>> *Team_deleted_by() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Team>> *>(
            VT_TEAM_DELETED_BY);
    }
    const flatbuffers::Vector<flatbuffers::Offset<TeamMembership>> *TeamMembership_user_id() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<TeamMembership>> *>(
            VT_TEAMMEMBERSHIP_USER_ID);
    }
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_ID)
            && verifier.Verify(id()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_CREATED_AT)
            ...
            && VerifyField<flatbuffers::uoffset_t>(verifier, VT_NAME) && verifier.Verify(name())
            && VerifyField<flatbuffers::uoffset_t>(verifier, VT_EMAIL) && verifier.Verify(email())
            ...
            && verifier.VerifyVectorOfTables(TeamMembership_user_id()) && verifier.EndTable();
    }
};
...
struct UserBuilder
{
    ...
    void add_deleted_at(flatbuffers::Offset<flatbuffers::String> deleted_at)
    {
        fbb_.AddOffset(User::VT_DELETED_AT, deleted_at);
    }
    void add_created_by(flatbuffers::Offset<flatbuffers::String> created_by)
    {
        fbb_.AddOffset(User::VT_CREATED_BY, created_by);
    }
    void add_updated_by(flatbuffers::Offset<flatbuffers::String> updated_by)
    {
        fbb_.AddOffset(User::VT_UPDATED_BY, updated_by);
    }
    void add_deleted_by(flatbuffers::Offset<flatbuffers::String> deleted_by)
    {
        fbb_.AddOffset(User::VT_DELETED_BY, deleted_by);
    }
    ...
    void add_birth_date(flatbuffers::Offset<flatbuffers::String> birth_date)
    {
        fbb_.AddOffset(User::VT_BIRTH_DATE, birth_date);
    }
    void add_personal_id(flatbuffers::Offset<flatbuffers::String> personal_id)
    {
        fbb_.AddOffset(User::VT_PERSONAL_ID, personal_id);
    }
    void add_professional_id(flatbuffers::Offset<flatbuffers::String> professional_id)
    {
        fbb_.AddOffset(User::VT_PROFESSIONAL_ID, professional_id);
    }
    void add_created_by_User(flatbuffers::Offset<User> created_by_User)
    {
        fbb_.AddOffset(User::VT_CREATED_BY_USER, created_by_User);
    }
    void add_updated_by_User(flatbuffers::Offset<User> updated_by_User)
    {
        fbb_.AddOffset(User::VT_UPDATED_BY_USER, updated_by_User);
    }
    void add_deleted_by_User(flatbuffers::Offset<User> deleted_by_User)
    {
        fbb_.AddOffset(User::VT_DELETED_BY_USER, deleted_by_User);
    }
    void add_User_created_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<User>>> User_created_by)
    {
        fbb_.AddOffset(User::VT_USER_CREATED_BY, User_created_by);
    }
    void add_User_updated_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<User>>> User_updated_by)
    {
        fbb_.AddOffset(User::VT_USER_UPDATED_BY, User_updated_by);
    }
    void add_User_deleted_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<User>>> User_deleted_by)
    {
        fbb_.AddOffset(User::VT_USER_DELETED_BY, User_deleted_by);
    }
    void add_Organization_created_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Organization>>>
            Organization_created_by)
    {
        fbb_.AddOffset(User::VT_ORGANIZATION_CREATED_BY, Organization_created_by);
    }
    void add_Organization_updated_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Organization>>>
            Organization_updated_by)
    {
        fbb_.AddOffset(User::VT_ORGANIZATION_UPDATED_BY, Organization_updated_by);
    }
    void add_Organization_deleted_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Organization>>>
            Organization_deleted_by)
    {
        fbb_.AddOffset(User::VT_ORGANIZATION_DELETED_BY, Organization_deleted_by);
    }
    void add_Team_created_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Team>>> Team_created_by)
    {
        fbb_.AddOffset(User::VT_TEAM_CREATED_BY, Team_created_by);
    }
    void add_Team_updated_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Team>>> Team_updated_by)
    {
        fbb_.AddOffset(User::VT_TEAM_UPDATED_BY, Team_updated_by);
    }
    void add_Team_deleted_by(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Team>>> Team_deleted_by)
    {
        fbb_.AddOffset(User::VT_TEAM_DELETED_BY, Team_deleted_by);
    }
    void add_TeamMembership_user_id(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<TeamMembership>>>
            TeamMembership_user_id)
    {
        fbb_.AddOffset(User::VT_TEAMMEMBERSHIP_USER_ID, TeamMembership_user_id);
    }
    UserBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb)
    {
...
inline flatbuffers::Offset<User> CreateUser(
    ...
    flatbuffers::Offset<User> created_by_User = 0, flatbuffers::Offset<User> updated_by_User = 0,
...
struct Organization FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    const flatbuffers::String *legal_id() const
    {
        return GetPointer<const flatbuffers::String *>(VT_LEGAL_ID);
    }
    ...
    const OrganizationType *type_id_OrganizationType() const
    {
        return GetPointer<const OrganizationType *>(VT_TYPE_ID_ORGANIZATIONTYPE);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Team>> *Team_organization_id() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Team>> *>(
            VT_TEAM_ORGANIZATION_ID);
    }
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_ID)
            ...
            && verifier.VerifyVectorOfTables(Team_organization_id()) && verifier.EndTable();
    }
};
...
struct OrganizationBuilder
{
    ...
    void add_created_at(flatbuffers::Offset<flatbuffers::String> created_at)
    {
        fbb_.AddOffset(Organization::VT_CREATED_AT, created_at);
    }
    void add_updated_at(flatbuffers::Offset<flatbuffers::String> updated_at)
    {
        fbb_.AddOffset(Organization::VT_UPDATED_AT, updated_at);
    }
    void add_deleted_at(flatbuffers::Offset<flatbuffers::String> deleted_at)
    {
        fbb_.AddOffset(Organization::VT_DELETED_AT, deleted_at);
    }
    void add_created_by(flatbuffers::Offset<flatbuffers::String> created_by)
    {
        fbb_.AddOffset(Organization::VT_CREATED_BY, created_by);
    }
    void add_updated_by(flatbuffers::Offset<flatbuffers::String> updated_by)
    {
        fbb_.AddOffset(Organization::VT_UPDATED_BY, updated_by);
    }
    void add_deleted_by(flatbuffers::Offset<flatbuffers::String> deleted_by)
    {
        fbb_.AddOffset(Organization::VT_DELETED_BY, deleted_by);
    }
    void add_name(flatbuffers::Offset<flatbuffers::String> name)
    {
    ...
    {
        fbb_.AddOffset(Organization::VT_TYPE_ID, type_id);
    }
    void add_legal_id(flatbuffers::Offset<flatbuffers::String> legal_id)
    {
        fbb_.AddOffset(Organization::VT_LEGAL_ID, legal_id);
    }
    ...
    void add_created_by_User(flatbuffers::Offset<User> created_by_User)
    {
        fbb_.AddOffset(Organization::VT_CREATED_BY_USER, created_by_User);
    }
    void add_updated_by_User(flatbuffers::Offset<User> updated_by_User)
    {
        fbb_.AddOffset(Organization::VT_UPDATED_BY_USER, updated_by_User);
    }
    void add_deleted_by_User(flatbuffers::Offset<User> deleted_by_User)
    {
        fbb_.AddOffset(Organization::VT_DELETED_BY_USER, deleted_by_User);
    }
    void add_type_id_OrganizationType(
        flatbuffers::Offset<OrganizationType> type_id_OrganizationType)
    {
        fbb_.AddOffset(Organization::VT_TYPE_ID_ORGANIZATIONTYPE, type_id_OrganizationType);
    }
    void add_Team_organization_id(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Team>>> Team_organization_id)
    {
        fbb_.AddOffset(Organization::VT_TEAM_ORGANIZATION_ID, Team_organization_id);
    }
    OrganizationBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb)
    {
        start_ = fbb_.StartTable();
    }
...
struct Team FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    const flatbuffers::String *organization_id() const
    {
        return GetPointer<const flatbuffers::String *>(VT_ORGANIZATION_ID);
    }
    const flatbuffers::String *name() const
    {
        return GetPointer<const flatbuffers::String *>(VT_NAME);
    ...
    const Organization *organization_id_Organization() const
    {
        return GetPointer<const Organization *>(VT_ORGANIZATION_ID_ORGANIZATION);
    }
    const flatbuffers::Vector<flatbuffers::Offset<TeamMembership>> *TeamMembership_team_id() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<TeamMembership>> *>(
            VT_TEAMMEMBERSHIP_TEAM_ID);
    }
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_ID)
            ...
            && verifier.VerifyVectorOfTables(TeamMembership_team_id()) && verifier.EndTable();
    }
};
...
struct TeamBuilder
{
    ...
    void add_id(flatbuffers::Offset<flatbuffers::String> id)
    {
        fbb_.AddOffset(Team::VT_ID, id);
    }
    void add_created_at(flatbuffers::Offset<flatbuffers::String> created_at)
    {
        fbb_.AddOffset(Team::VT_CREATED_AT, created_at);
    }
    void add_updated_at(flatbuffers::Offset<flatbuffers::String> updated_at)
    {
        fbb_.AddOffset(Team::VT_UPDATED_AT, updated_at);
    }
    void add_deleted_at(flatbuffers::Offset<flatbuffers::String> deleted_at)
    {
        fbb_.AddOffset(Team::VT_DELETED_AT, deleted_at);
    }
    void add_created_by(flatbuffers::Offset<flatbuffers::String> created_by)
    {
        fbb_.AddOffset(Team::VT_CREATED_BY, created_by);
    }
    void add_updated_by(flatbuffers::Offset<flatbuffers::String> updated_by)
    {
        fbb_.AddOffset(Team::VT_UPDATED_BY, updated_by);
    }
    void add_deleted_by(flatbuffers::Offset<flatbuffers::String> deleted_by)
    {
        fbb_.AddOffset(Team::VT_DELETED_BY, deleted_by);
    }
    void add_organization_id(flatbuffers::Offset<flatbuffers::String> organization_id)
    {
        fbb_.AddOffset(Team::VT_ORGANIZATION_ID, organization_id);
    }
    void add_name(flatbuffers::Offset<flatbuffers::String> name)
    {
        fbb_.AddOffset(Team::VT_NAME, name);
    }
    void add_description(flatbuffers::Offset<flatbuffers::String> description)
    {
        fbb_.AddOffset(Team::VT_DESCRIPTION, description);
    }
    void add_created_by_User(flatbuffers::Offset<User> created_by_User)
    {
        fbb_.AddOffset(Team::VT_CREATED_BY_USER, created_by_User);
    }
    void add_updated_by_User(flatbuffers::Offset<User> updated_by_User)
    {
        fbb_.AddOffset(Team::VT_UPDATED_BY_USER, updated_by_User);
    }
    void add_deleted_by_User(flatbuffers::Offset<User> deleted_by_User)
    {
        fbb_.AddOffset(Team::VT_DELETED_BY_USER, deleted_by_User);
    }
    void add_organization_id_Organization(
        flatbuffers::Offset<Organization> organization_id_Organization)
    {
        fbb_.AddOffset(Team::VT_ORGANIZATION_ID_ORGANIZATION, organization_id_Organization);
    }
    void add_TeamMembership_team_id(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<TeamMembership>>>
            TeamMembership_team_id)
    {
        fbb_.AddOffset(Team::VT_TEAMMEMBERSHIP_TEAM_ID, TeamMembership_team_id);
    }
    TeamBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb)
    {
        start_ = fbb_.StartTable();
    }
...
struct OrganizationType FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    const flatbuffers::Vector<flatbuffers::Offset<Organization>> *Organization_type_id() const
    {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Organization>> *>(
            VT_ORGANIZATION_TYPE_ID);
    }
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_ID)
            && verifier.Verify(id()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_NAME)
            && verifier.Verify(name())
            && VerifyField<flatbuffers::uoffset_t>(verifier, VT_DESCRIPTION)
            && verifier.Verify(description())
            && VerifyField<flatbuffers::uoffset_t>(verifier, VT_ORGANIZATION_TYPE_ID)
            && verifier.Verify(Organization_type_id())
            && verifier.VerifyVectorOfTables(Organization_type_id()) && verifier.EndTable();
    }
};
...
struct OrganizationTypeBuilder
{
    ...
    void add_id(flatbuffers::Offset<flatbuffers::String> id)
    {
        fbb_.AddOffset(OrganizationType::VT_ID, id);
    }
    void add_name(flatbuffers::Offset<flatbuffers::String> name)
    {
        fbb_.AddOffset(OrganizationType::VT_NAME, name);
    }
    void add_description(flatbuffers::Offset<flatbuffers::String> description)
    {
        fbb_.AddOffset(OrganizationType::VT_DESCRIPTION, description);
    }
    void add_Organization_type_id(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Organization>>>
            Organization_type_id)
    {
        fbb_.AddOffset(OrganizationType::VT_ORGANIZATION_TYPE_ID, Organization_type_id);
    }
    OrganizationTypeBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb)
    {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<OrganizationType> CreateOrganizationType(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::String> id = 0,
    flatbuffers::Offset<flatbuffers::String> name = 0,
    flatbuffers::Offset<flatbuffers::String> description = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Organization>>> Organization_type_id
    = 0)
{
...
struct TeamMembership FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
    ...
    const flatbuffers::String *team_id() const
    {
        return GetPointer<const flatbuffers::String *>(VT_TEAM_ID);
    }
    const flatbuffers::String *user_id() const
    {
        return GetPointer<const flatbuffers::String *>(VT_USER_ID);
    }
    const User *user_id_User() const
    {
        return GetPointer<const User *>(VT_USER_ID_USER);
    }
    const Team *team_id_Team() const
    {
        return GetPointer<const Team *>(VT_TEAM_ID_TEAM);
    }
    bool Verify(flatbuffers::Verifier &verifier) const
    {
        return VerifyTableStart(verifier) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_ID)
            && verifier.Verify(id()) && VerifyField<flatbuffers::uoffset_t>(verifier, VT_TEAM_ID)
            ...
            && verifier.VerifyTable(team_id_Team()) && verifier.EndTable();
    }
};
...
struct TeamMembershipBuilder
{
    ...
    void add_id(flatbuffers::Offset<flatbuffers::String> id)
    {
        fbb_.AddOffset(TeamMembership::VT_ID, id);
    }
    void add_team_id(flatbuffers::Offset<flatbuffers::String> team_id)
    {
        fbb_.AddOffset(TeamMembership::VT_TEAM_ID, team_id);
    }
    void add_user_id(flatbuffers::Offset<flatbuffers::String> user_id)
    {
        fbb_.AddOffset(TeamMembership::VT_USER_ID, user_id);
    }
    void add_user_id_User(flatbuffers::Offset<User> user_id_User)
    {
        fbb_.AddOffset(TeamMembership::VT_USER_ID_USER, user_id_User);
    }
    void add_team_id_Team(flatbuffers::Offset<Team> team_id_Team)
    {
        fbb_.AddOffset(TeamMembership::VT_TEAM_ID_TEAM, team_id_Team);
    }
    TeamMembershipBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb)
    {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<TeamMembership> CreateTeamMembership(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::String> id = 0,
    flatbuffers::Offset<flatbuffers::String> team_id = 0,
    flatbuffers::Offset<flatbuffers::String> user_id = 0,
    flatbuffers::Offset<User> user_id_User = 0, flatbuffers::Offset<Team> team_id_Team = 0)
{
...
{
    return verifier.VerifyBuffer<flat::User>();
}
#endif

inline void FinishUserBuffer(
    flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<flat::User> root)
{
    fbb.Finish(root);
}
